...
export default function DialogPage({ dialogText, dialogTitle, dialogDescription }: DialogPageProps) {
    return (
      <Dialog>
        <DialogTrigger className="px-4 py-2 mt-4 text-sm font-bold text-white transition duration-500 bg-slate-500 rounded-full hover:bg-slate-400 hover:text-slate-300">{dialogText}</DialogTrigger>
        <DialogContent>
          <DialogHeader>
